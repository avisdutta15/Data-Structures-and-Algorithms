...
/*
	...
	Approach 2: Prefix Sum
		Preprocess and create a prefix sum. O(N)
		For every query - return (left == 0) ? prefixSum[right] : prefixSum[right] - prefixSum[left - 1]; O(1)
*/

class NumArray {
	vector<int> prefixSum;
public:
	//Setup the prefixSum in O(n)
