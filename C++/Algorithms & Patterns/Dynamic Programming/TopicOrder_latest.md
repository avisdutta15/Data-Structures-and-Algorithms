...
|-------|-------|-------------|
|**1. 0/1 Knapsack**| 416 | Partition Equal Subset Sum|
|                   | 494 | Target Sum |
...
|**5. Palindromic Subsequence**|     | Longest Palindromic Subsequence (Length + Print)
...
|**6. Longest Common Substring**|     | Longest Common Substring 
...
|**7. Edit Distance**|72  | Edit Distance 
|                   | 583 | Delete Operation for Two Strings
|                   | 712 | Minimum ASCII Delete Sum for Two Strings
|**8. Longest Increasing Subsequence (LIS)**|300 | Longest Increasing Subsequence
