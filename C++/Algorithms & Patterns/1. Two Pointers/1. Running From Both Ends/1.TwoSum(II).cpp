...
/*
    ...
    One pointer at the beginning (i) and one at the end (j).
    Calculate the sum of elements at these pointers.
        If sum equals target, we found our answer.
        If sum is less than target, move the left pointer forward (i++).
        If sum is greater than target, move the right pointer backward (j--).
*/
